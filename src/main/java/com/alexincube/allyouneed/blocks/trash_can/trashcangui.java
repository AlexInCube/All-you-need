...
public class trashcangui extends ContainerScreen<trashcancontainer> {
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(allyouneed.MODID, "textures/gui/container/trash_can_gui.png");

    public trashcangui(final trashcancontainer container, final PlayerInventory inventory, final ITextComponent title) {
